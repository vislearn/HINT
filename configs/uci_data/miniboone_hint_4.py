...
from data import prepare_uci_loaders, Miniboone as model
...
c = {
    # GENERAL STUFF
    'suffix': f'{model.name}_hint-4', # identifier for trained models and outputs
    ...
    # MODEL ARCHITECTURE
    'n_blocks': 4,
    # 'hidden_layer_sizes': 152, # 500k
    'hidden_layer_sizes': 102, # 250k
    'init_scale': 0.005,
...
# DATA LOADERS
train_loader, test_loader = prepare_uci_loaders(c['data_model'].name, c['batch_size'])
