...
c = {
    # GENERAL STUFF
    'suffix': f'{model.name}_unconditional_hint-16-1', # identifier for trained models and outputs
...
for i in range(c['n_blocks']):
    ...
    x_lane.append(Node(x_lane[-1],
                       ...
                       {'c_internal': [c['hidden_layer_sizes'], c['hidden_layer_sizes']//2],
                        'max_splits': 1},
                       name=f'hac_{i+1}'))
