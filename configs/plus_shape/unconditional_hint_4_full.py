...
c = {
    # GENERAL STUFF
    'suffix': f'{model.name}_unconditional_hint-4-full', # identifier for trained models and outputs
...
for i in range(c['n_blocks']):
    ...
    x_lane.append(Node(x_lane[-1],
                       ...
                       {'c_internal': [c['hidden_layer_sizes'], c['hidden_layer_sizes']//2, c['hidden_layer_sizes']//4, c['hidden_layer_sizes']//8, c['hidden_layer_sizes']//8]},
                       name=f'hac_{i+1}'))
