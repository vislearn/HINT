...
c = {
    # GENERAL STUFF
    'suffix': f'{model.name}_unconditional_hint-4-3-lessshrink', # identifier for trained models and outputs
    ...
    'pre_low_lr': 1, # number of epochs at the start with very low learning rate
...
for i in range(c['n_blocks']):
    ...
    x_lane.append(Node(x_lane[-1],
                       ...
                       {'c_internal': [c['hidden_layer_sizes'], int(c['hidden_layer_sizes']//sqrt(2)), c['hidden_layer_sizes']//2, int(c['hidden_layer_sizes']//(2*sqrt(2)))],
