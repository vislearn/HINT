...
c = {
    # GENERAL STUFF
    'suffix': f'{model.name}_unconditional_hint-4-3-constwidth', # identifier for trained models and outputs
...
for i in range(c['n_blocks']):
    ...
    x_lane.append(Node(x_lane[-1],
                       ...
                       {'c_internal': [c['hidden_layer_sizes']],
